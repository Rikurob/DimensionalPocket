...
package net.mcreator.dimensionalpockets.world.biome;
...
public class PocketDimensionBiomeBiome {
	...
	public static void init() {
		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new ResourceLocation(DimensionalpocketsMod.MODID, "pocket_dimension_biome"),
				SURFACE_BUILDER);
	...
	private static ConfiguredFeature<?, ?> register(String name, ConfiguredFeature<?, ?> configuredFeature) {
		CONFIGURED_FEATURES.put(new ResourceLocation(DimensionalpocketsMod.MODID, name + "_pocket_dimension_biome"), configuredFeature);
