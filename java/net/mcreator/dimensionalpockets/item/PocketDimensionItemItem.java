...
import net.mcreator.dimensionalpockets.procedures.PocketDimensionUseProcedure;
import net.mcreator.dimensionalpockets.procedures.PocketDimensionItemMakeItemGlowProcedure;
...
public class PocketDimensionItemItem extends Item {
	public PocketDimensionItemItem() {
		super(new Item.Properties().tab(DimensionalpocketsModTabs.TAB_DIMENSIONAL_POCKETS).stacksTo(1).fireResistant().rarity(Rarity.RARE));
