...
import net.mcreator.dimensionalpockets.world.features.ores.EnderStoneFeature;
...
public class DimensionalpocketsModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(EnderStoneFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_ORES, EnderStoneFeature.GENERATE_BIOMES,
				EnderStoneFeature.CONFIGURED_FEATURE));
	}
