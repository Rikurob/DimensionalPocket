...
package net.dimensionalpocketz.world.biome;
...
public class PocketDimensionBiomeBiome {
	...
	public static void init() {
		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new ResourceLocation(DimensionalpocketzMod.MODID, "pocket_dimension_biome"),
				SURFACE_BUILDER);
	...
	private static ConfiguredFeature<?, ?> register(String name, ConfiguredFeature<?, ?> configuredFeature) {
		CONFIGURED_FEATURES.put(new ResourceLocation(DimensionalpocketzMod.MODID, name + "_pocket_dimension_biome"), configuredFeature);
