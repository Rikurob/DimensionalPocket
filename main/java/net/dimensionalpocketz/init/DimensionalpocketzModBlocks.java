...
import net.dimensionalpocketz.block.StoneEnchantingtableBlock;
import net.dimensionalpocketz.block.OverworldPortalBlock;
import net.dimensionalpocketz.block.EnderStoneBlock;
import net.dimensionalpocketz.block.DimensionalPortalBlock;
import net.dimensionalpocketz.block.DimensionalFireBlock;

import java.util.List;
import java.util.ArrayList;

@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
public class DimensionalpocketzModBlocks {
